                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="text-center">
                                                                        <button onclick="approve(this)" data-id="<?= $students_arr[$i]['id'] ?>" class="btn btn-secondary btn-sm rounded-0"><i class="fas fa-check"></i> อนุมัติ</button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        for ($i = 0; $i < count($agencies_arr); $i++) { ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="text-center">
                                                                        <button onclick="approve(this)" data-id="<?= $agencies_arr[$i]['id'] ?>" class="btn btn-secondary btn-sm rounded-0"><i class="fas fa-check"></i> อนุมัติ</button>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
